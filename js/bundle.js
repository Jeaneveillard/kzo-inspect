(() => {
  ...
  var SECTION_PRESETS = {
    "walk-terrain": { conforme: [{ id: "terrain-c-1", label: "Pente ad\xE9quate — eaux s'\xE9loignent des fondations" }, { id: "terrain-c-2", label: "V\xE9g\xE9tation \xE0 distance raisonnable du b\xE2timent" }, { id: "terrain-c-3", label: "Drainage de surface fonctionnel" }, { id: "terrain-c-4", label: "Cl\xF4ture de piscine conforme — 1,2 m et loquet s\xE9curit\xE9" }, { id: "terrain-c-5", label: "Margelle en bon \xE9tat — joints intacts, surface stable" }], "non-conforme": [{ id: "terrain-nc-1", label: "Pente vers les fondations — infiltration probable" }, { id: "terrain-nc-2", label: "Racines endommageant la fondation" }, { id: "terrain-nc-3", label: "Mur de sout\xE8nement instable — risque structural" }, { id: "terrain-nc-4", label: "Cl\xF4ture de piscine absente ou non conforme — Loi 33 Qu\xE9bec" }, { id: "terrain-nc-5", label: "Loquet de s\xE9curit\xE9 piscine absent — danger enfants" }], "a-corriger": [{ id: "terrain-ac-1", label: "Remblai insuffisant le long des fondations" }, { id: "terrain-ac-2", label: "V\xE9g\xE9tation trop proche — \xE0 tailler" }, { id: "terrain-ac-3", label: "Regard de drainage obstru\xE9 ou absent" }, { id: "terrain-ac-4", label: "Margelle fissur\xE9e ou joints d\xE9t\xE9rior\xE9s — r\xE9paration \xE0 pr\xE9voir" }] },
    "bnq-w-terrain": "walk-terrain", "bat-terrain": "walk-terrain",
    "walk-fondations": { conforme: [{ id: "fond-c-1", label: "Aucune fissure significative observ\xE9e" }, { id: "fond-c-2", label: "Mur de fondation sec et intact" }, { id: "fond-c-3", label: "Aucun signe d'efflorescence ou d'infiltration" }], "non-conforme": [{ id: "fond-nc-1", label: "Fissure diagonale — mouvement structurel probable" }, { id: "fond-nc-2", label: "Infiltration active au mur de fondation" }, { id: "fond-nc-3", label: "Efflorescence importante — humidit\xE9 chronique" }, { id: "fond-nc-4", label: "Affaissement ou d\xE9placement visible" }], "a-corriger": [{ id: "fond-ac-1", label: "Fissures fines — cycle gel-d\xE9gel \xE0 surveiller" }, { id: "fond-ac-2", label: "Efflorescence l\xE9g\xE8re — drainage \xE0 am\xE9liorer" }, { id: "fond-ac-3", label: "Joints de mortier d\xE9grad\xE9s — repointing requis" }] },
    "bnq-w-fondations": "walk-fondations", "bat-fondations": "walk-fondations",
    "walk-toiture": { conforme: [{ id: "toit-c-1", label: "Rev\xEAtement en bon \xE9tat apparent" }, { id: "toit-c-2", label: "Goutti\xE8res et descentes fonctionnelles" }, { id: "toit-c-3", label: "Solins \xE9tanches — aucun d\xE9collement" }, { id: "toit-c-4", label: "Chemin\xE9e et \xE9mergences en bon \xE9tat" }, { id: "toit-c-5", label: "Soffites d\xE9gag\xE9s — ventilation ad\xE9quate visible" }], "non-conforme": [{ id: "toit-nc-1", label: "Bardeaux manquants, soulev\xE9s ou granulats absents" }, { id: "toit-nc-2", label: "Solin d\xE9coll\xE9 — infiltration probable" }, { id: "toit-nc-3", label: "Membrane endommag\xE9e (toit plat)" }, { id: "toit-nc-4", label: "Dommage structurel apparent — intervention urgente" }, { id: "toit-nc-5", label: "Soffites obstru\xE9s — risque de condensation en comble" }], "a-corriger": [{ id: "toit-ac-1", label: "Toiture en fin de vie — remplacement \xE0 planifier" }, { id: "toit-ac-2", label: "Goutti\xE8res obstru\xE9es ou mal fix\xE9es" }, { id: "toit-ac-3", label: "Calfeutrage d'\xE9mergence \xE0 refaire" }, { id: "toit-ac-4", label: "Traces de glace en rive — am\xE9liorer l'isolation et la ventilation" }] },
    "bnq-w-toiture": "walk-toiture", "bat-toiture": "walk-toiture",
    "walk-facades": { conforme: [{ id: "facade-c-1", label: "Rev\xEAtement mural sans fissure significative" }, { id: "facade-c-2", label: "Boiseries et fascias en bon \xE9tat" }, { id: "facade-c-3", label: "Calfeutrage des ouvertures en bon \xE9tat" }], "non-conforme": [{ id: "facade-nc-1", label: "Pourriture visible au rev\xEAtement ou boiseries" }, { id: "facade-nc-2", label: "Fissures ouvertes — infiltration probable" }, { id: "facade-nc-3", label: "Lambris bomb\xE9 ou mal fix\xE9 — d\xE9tachement possible" }], "a-corriger": [{ id: "facade-ac-1", label: "Peinture \xE9caill\xE9e — entretien pr\xE9ventif requis" }, { id: "facade-ac-2", label: "Calfeutrage fen\xEAtres \xE0 refaire" }, { id: "facade-ac-3", label: "Fascia ou sous-face \xE0 repeindre ou remplacer" }] },
    "bnq-w-facades": "walk-facades", "bat-facades": "walk-facades",
    "walk-ouvertures": { conforme: [{ id: "ouv-c-1", label: "Fen\xEAtres en bon \xE9tat — joint et ch\xE2ssis intacts" }, { id: "ouv-c-2", label: "Portes ext\xE9rieures fonctionnelles et \xE9tanches" }, { id: "ouv-c-3", label: "Garde-corps conformes et stables" }, { id: "ouv-c-4", label: "Marches et paliers en bon \xE9tat" }], "non-conforme": [{ id: "ouv-nc-1", label: "Garde-corps absent ou hauteur insuffisante — chute" }, { id: "ouv-nc-2", label: "Marches dangereuses — risque de tr\xE9bucher" }, { id: "ouv-nc-3", label: "Porte de garage : arr\xEAt sur obstacle non fonctionnel" }], "a-corriger": [{ id: "ouv-ac-1", label: "Condensation entre vitrages — scellant d\xE9ficient" }, { id: "ouv-ac-2", label: "Fen\xEAtre difficile \xE0 op\xE9rer — ajustement requis" }, { id: "ouv-ac-3", label: "Joint de seuil \xE0 remplacer" }] },
    "bnq-w-ouvertures": "walk-ouvertures", "bat-ouvertures": "walk-ouvertures",
    "walk-plomb-ext": { conforme: [{ id: "plomb-ext-c-1", label: "Robinet ext\xE9rieur fonctionnel — brise-vide pr\xE9sent" }, { id: "plomb-ext-c-2", label: "\xC9vents de plomberie d\xE9gag\xE9s" }, { id: "plomb-ext-c-3", label: "Aucune fuite visible en ext\xE9rieur" }], "non-conforme": [{ id: "plomb-ext-nc-1", label: "Brise-vide absent sur robinet ext\xE9rieur" }, { id: "plomb-ext-nc-2", label: "Fuite visible \xE0 la tuyauterie ext\xE9rieure" }], "a-corriger": [{ id: "plomb-ext-ac-1", label: "Robinet ext\xE9rieur difficile \xE0 op\xE9rer" }, { id: "plomb-ext-ac-2", label: "\xC9vent de plomberie partiellement obstru\xE9" }] },
    "bnq-w-plomb-ext": "walk-plomb-ext", "bat-plomb-ext": "walk-plomb-ext",
    "walk-elec-ext": { conforme: [{ id: "elec-ext-c-1", label: "Entr\xE9e de service en bon \xE9tat et bien ancr\xE9e" }, { id: "elec-ext-c-2", label: "Mise \xE0 la terre visible et connect\xE9e" }, { id: "elec-ext-c-3", label: "Coffret ext\xE9rieur ferm\xE9 et en bon \xE9tat" }], "non-conforme": [{ id: "elec-ext-nc-1", label: "M\xE2t d'entr\xE9e mal ancr\xE9 — risque structural" }, { id: "elec-ext-nc-2", label: "C\xE2blage d\xE9nud\xE9 ou mal prot\xE9g\xE9 \xE0 l'entr\xE9e" }, { id: "elec-ext-nc-3", label: "Hauteur des fils insuffisante — s\xE9curit\xE9" }], "a-corriger": [{ id: "elec-ext-ac-1", label: "Conduit d'entr\xE9e \xE0 res\xE9curiser" }, { id: "elec-ext-ac-2", label: "Coffret \xE0 inspecter par \xE9lectricien certifi\xE9" }] },
    "bnq-w-elec-ext": "walk-elec-ext", "bat-elec-ext": "walk-elec-ext",
    "aibq-v-i-17": { conforme: [{ id: "struct-c-1", label: "Structure apparente sans d\xE9formation notable" }, { id: "struct-c-2", label: "Planchers de niveau — aucun affaissement" }, { id: "struct-c-3", label: "Poutres et solives sans signe de d\xE9gradation" }], "non-conforme": [{ id: "struct-nc-1", label: "Affaissement de plancher — intervention structurale" }, { id: "struct-nc-2", label: "Pourriture ou dommage par eau \xE0 la structure" }, { id: "struct-nc-3", label: "Fissure structurelle active — expert requis" }], "a-corriger": [{ id: "struct-ac-1", label: "Craquement excessif au plancher" }, { id: "struct-ac-2", label: "Plafond l\xE9g\xE8rement d\xE9form\xE9 — surveillance" }, { id: "struct-ac-3", label: "Humidit\xE9 sur la structure — source \xE0 identifier" }] },
    "aibq-v-i": "aibq-v-i-17",
    "aibq-v-iv": { conforme: [{ id: "plomb-c-1", label: "Tuyauterie en bon \xE9tat — aucune fuite visible" }, { id: "plomb-c-2", label: "Chauffe-eau fonctionnel — soupape T&P en place" }, { id: "plomb-c-3", label: "Robinet d'arr\xEAt principal rep\xE9r\xE9 et op\xE9rationnel" }, { id: "plomb-c-4", label: "\xC9vacuation efficace — aucun refoulement" }, { id: "plomb-c-5", label: "Temp\xE9rature eau chaude dans les limites (49-60 \xB0C)" }], "non-conforme": [{ id: "plomb-nc-1", label: "Fuite active \xE0 la tuyauterie" }, { id: "plomb-nc-2", label: "Soupape T&P absente ou obstru\xE9e — surpression" }, { id: "plomb-nc-3", label: "Tuyauterie en polybutyl\xE8ne (Poly-B) — remplacement requis" }, { id: "plomb-nc-4", label: "Refoulement au drain — obstruction d'\xE9gout" }, { id: "plomb-nc-5", label: "Tuyaux de plomb suspect\xE9s — test et remplacement recommand\xE9s" }], "a-corriger": [{ id: "plomb-ac-1", label: "Chauffe-eau en fin de vie estim\xE9e" }, { id: "plomb-ac-2", label: "Tuyauterie en galvanis\xE9 — remplacement \xE0 planifier" }, { id: "plomb-ac-3", label: "Pression d'eau faible — v\xE9rification recommand\xE9e" }, { id: "plomb-ac-4", label: "Odeur d'\xE9gout — joint \xE0 inspecter" }, { id: "plomb-ac-5", label: "Anode chauffe-eau — entretien pr\xE9ventif recommand\xE9" }] },
    "bnq-12-3": "aibq-v-iv",
    "aibq-v-v": { conforme: [{ id: "elec-c-1", label: "Panneau en bon \xE9tat — circuits identifi\xE9s" }, { id: "elec-c-2", label: "C\xE2blage apparent conforme — aucun fil d\xE9nud\xE9" }, { id: "elec-c-3", label: "DDFT fonctionnels aux zones humides" }, { id: "elec-c-4", label: "Amp\xE9rage panneau ad\xE9quat (100 A ou plus)" }, { id: "elec-c-5", label: "Circuits d\xE9di\xE9s 240 V pr\xE9sents (cuisini\xE8re, s\xE9cheuse)" }], "non-conforme": [{ id: "elec-nc-1", label: "Surprotection au panneau — fusible surdimensionn\xE9" }, { id: "elec-nc-2", label: "C\xE2blage aluminium — inspection CMEQ recommand\xE9e" }, { id: "elec-nc-3", label: "Panneau Federal Pacific / Zinsco — remplacement" }, { id: "elec-nc-4", label: "Fil d\xE9nud\xE9 ou bo\xEEte de jonction ouverte — danger" }, { id: "elec-nc-5", label: "Double-tap au panneau — non conforme, correction requise" }], "a-corriger": [{ id: "elec-ac-1", label: "Liste des circuits absente ou incompl\xE8te" }, { id: "elec-ac-2", label: "Prise non mise \xE0 la terre en zone humide" }, { id: "elec-ac-3", label: "Disjoncteurs difficiles \xE0 manoeuvrer — usure" }, { id: "elec-ac-4", label: "Panneau 60 A — mise \xE0 niveau recommand\xE9e selon usage" }] },
    "bnq-12-4": "aibq-v-v",
    "aibq-v-vi": { conforme: [{ id: "chauf-c-1", label: "Syst\xE8me fonctionnel aux commandes normales" }, { id: "chauf-c-2", label: "Filtres en bon \xE9tat — entretien r\xE9cent" }, { id: "chauf-c-3", label: "Conduits de distribution sans fuite apparente" }, { id: "chauf-c-4", label: "Thermostat fonctionnel — r\xE9ponse correcte au r\xE9glage" }, { id: "chauf-c-5", label: "Foyer / po\xEAle : plaque certification pr\xE9sente et conforme" }], "non-conforme": [{ id: "chauf-nc-1", label: "Syst\xE8me non fonctionnel — intervention requise" }, { id: "chauf-nc-2", label: "Conduit de fum\xE9e d\xE9coll\xE9 — risque CO" }, { id: "chauf-nc-3", label: "Tuyauterie de gaz corrod\xE9e — inspection gazi\xE8re" }, { id: "chauf-nc-4", label: "\xC9changeur thermique suspect — fissure ou odeur br\xFBl\xE9e" }, { id: "chauf-nc-5", label: "Foyer / po\xEAle sans plaque de certification — non conforme" }], "a-corriger": [{ id: "chauf-ac-1", label: "Filtre \xE0 remplacer" }, { id: "chauf-ac-2", label: "Chaudi\xE8re ou fournaise en fin de vie estim\xE9e" }, { id: "chauf-ac-3", label: "Bruit anormal au d\xE9marrage — inspection recommand\xE9e" }, { id: "chauf-ac-4", label: "D\xE9tecteur CO absent — installation obligatoire" }, { id: "chauf-ac-5", label: "Plinthe \xE9lectrique d\xE9faillante dans une pi\xE8ce" }, { id: "chauf-ac-6", label: "Thermostat — pile \xE0 remplacer ou recalibrage recommand\xE9" }] },
    "bnq-12-5": "aibq-v-vi",
    "aibq-v-vii": { conforme: [{ id: "clim-c-1", label: "Thermopompe fonctionnelle aux commandes normales" }, { id: "clim-c-2", label: "Drainage des condensats en place" }, { id: "clim-c-3", label: "Unit\xE9 ext\xE9rieure en bon \xE9tat g\xE9n\xE9ral" }], "non-conforme": [{ id: "clim-nc-1", label: "Syst\xE8me non fonctionnel — intervention requise" }, { id: "clim-nc-2", label: "Drainage condensats absent ou obstru\xE9" }], "a-corriger": [{ id: "clim-ac-1", label: "Unit\xE9 ext\xE9rieure en fin de vie estim\xE9e" }, { id: "clim-ac-2", label: "Entretien annuel recommand\xE9" }] },
    "aibq-v-viii": { conforme: [{ id: "int-c-1", label: "Finitions en bon \xE9tat g\xE9n\xE9ral" }, { id: "int-c-2", label: "Portes et fen\xEAtres int\xE9rieures fonctionnelles" }, { id: "int-c-3", label: "Escaliers et garde-corps stables" }, { id: "int-c-4", label: "Aucune tache d'humidit\xE9 visible" }, { id: "int-c-5", label: "Joints de silicone douche/bain intacts — aucune moisissure" }, { id: "int-c-6", label: "Carrelage en bon \xE9tat — joints et tuiles intacts" }], "non-conforme": [{ id: "int-nc-1", label: "Taches d'humidit\xE9 actives — infiltration en cours" }, { id: "int-nc-2", label: "Moisissure visible — investigation requise" }, { id: "int-nc-3", label: "Garde-corps int\xE9rieur d\xE9ficient — risque de chute" }, { id: "int-nc-4", label: "Joint silicone douche absent ou d\xE9coll\xE9 — infiltration probable" }], "a-corriger": [{ id: "int-ac-1", label: "Taches d'humidit\xE9 anciennes — surveillance" }, { id: "int-ac-2", label: "Plancher craquant excessivement" }, { id: "int-ac-3", label: "Porte int\xE9rieure difficile \xE0 fermer" }, { id: "int-ac-4", label: "Joints silicone \xE0 refaire dans la salle de bain" }, { id: "int-ac-5", label: "Carrelage d\xE9coll\xE9 ou joint fissur\xE9 — r\xE9paration \xE0 pr\xE9voir" }] },
    "bnq-12-6": "aibq-v-viii",
    "aibq-v-ix": { conforme: [{ id: "iso-c-1", label: "Isolation visible en quantit\xE9 ad\xE9quate" }, { id: "iso-c-2", label: "Pare-vapeur visible et intact" }, { id: "iso-c-3", label: "Aucun signe de moisissure \xE0 l'isolant" }], "non-conforme": [{ id: "iso-nc-1", label: "Isolation absente dans zone accessible" }, { id: "iso-nc-2", label: "Pare-vapeur absent — condensation probable" }, { id: "iso-nc-3", label: "Moisissure sur l'isolant — humidit\xE9 chronique" }], "a-corriger": [{ id: "iso-ac-1", label: "Isolation \xE0 compl\xE9ter dans certaines zones" }, { id: "iso-ac-2", label: "Pont thermique apparent — \xE0 corriger" }, { id: "iso-ac-3", label: "Taches sur la structure — source \xE0 identifier" }] },
    "bnq-12-7": "aibq-v-ix",
    "aibq-v-x": { conforme: [{ id: "vent-c-1", label: "Ventilation de comble ad\xE9quate — \xE9vents d\xE9gag\xE9s" }, { id: "vent-c-2", label: "Ventilateurs salle de bain et cuisine fonctionnels" }, { id: "vent-c-3", label: "\xC9changeur d'air pr\xE9sent et accessible" }], "non-conforme": [{ id: "vent-nc-1", label: "\xC9vent de s\xE9cheuse obstru\xE9 — risque d'incendie" }, { id: "vent-nc-2", label: "Ventilateur de salle de bain non fonctionnel" }, { id: "vent-nc-3", label: "Ventilation de comble insuffisante" }], "a-corriger": [{ id: "vent-ac-1", label: "\xC9changeur d'air \xE0 entretenir — filtres \xE0 changer" }, { id: "vent-ac-2", label: "Ventilateur de cuisine \xE9vacuant dans le comble" }, { id: "vent-ac-3", label: "\xC9vent partiellement obstru\xE9" }] },
    "aibq-v-xi": { conforme: [{ id: "secu-c-1", label: "D\xE9tecteurs de fum\xE9e pr\xE9sents visuellement" }, { id: "secu-c-2", label: "D\xE9tecteurs CO pr\xE9sents aux zones requises" }, { id: "secu-c-3", label: "Garde-corps et rampes conformes en hauteur" }, { id: "secu-c-4", label: "Issues d'\xE9vacuation d\xE9gag\xE9es" }, { id: "secu-c-5", label: "Cl\xF4ture de piscine conforme — 1,2 m et loquet s\xE9curit\xE9" }, { id: "secu-c-6", label: "Puits anglais : grille de protection en place" }], "non-conforme": [{ id: "secu-nc-1", label: "D\xE9tecteur de fum\xE9e absent — zone requise" }, { id: "secu-nc-2", label: "D\xE9tecteur CO absent — installation obligatoire" }, { id: "secu-nc-3", label: "Garde-corps d\xE9ficient — risque de chute grave" }, { id: "secu-nc-4", label: "Cl\xF4ture de piscine absente ou non conforme — Loi 33 Qu\xE9bec" }, { id: "secu-nc-5", label: "Puits anglais sans grille — risque de chute" }], "a-corriger": [{ id: "secu-ac-1", label: "D\xE9tecteurs > 10 ans — remplacement recommand\xE9" }, { id: "secu-ac-2", label: "Rampe d'escalier \xE0 s\xE9curiser" }, { id: "secu-ac-3", label: "Hauteur de garde-corps \xE0 v\xE9rifier" }, { id: "secu-ac-4", label: "Margelle de piscine fissur\xE9e — r\xE9paration \xE0 pr\xE9voir" }] },
    "bnq-12-8": "aibq-v-xi",
    "aibq-matieres-dan": { conforme: [{ id: "md-c-1", label: "Aucun indice visuel de mati\xE8re dangereuse observ\xE9" }, { id: "md-c-2", label: "Isolation combles : fibre de verre ou cellulose (non amiant\xE9 probable)" }, { id: "md-c-3", label: "Dalle en b\xE9ton sans fissure en r\xE9seau — pyrite non suspect\xE9e" }], "non-conforme": [{ id: "md-nc-1", label: "Isolant en vrac granuleux argent\xE9 (vermiculite/Zonolite) — test amiante recommand\xE9" }, { id: "md-nc-2", label: "Plafond popcorn / tuiles acoustiques — analyse amiante recommand\xE9e" }, { id: "md-nc-3", label: "Dalle soulev\xE9e / fissures en r\xE9seau — test pyrite recommand\xE9" }, { id: "md-nc-4", label: "Tuyaux de plomb suspect\xE9s — analyse et remplacement recommand\xE9s" }, { id: "md-nc-5", label: "Isolant en mousse jaune/beige dans les murs — FUUF possible (pr\xE9-1982)" }, { id: "md-nc-6", label: "R\xE9servoir d'huile pr\xE9sent — risque de contamination du sol" }, { id: "md-nc-7", label: "Thermostat \xE0 ampoule de mercure — retrait par r\xE9cup\xE9rateur recommand\xE9" }], "a-corriger": [{ id: "md-ac-1", label: "Test de radon recommand\xE9 — r\xE9gion \xE0 risque mod\xE9r\xE9 \xE0 \xE9lev\xE9" }, { id: "md-ac-2", label: "Peinture \xE9caill\xE9e sur boiseries pr\xE9-1975 — test plomb recommand\xE9" }, { id: "md-ac-3", label: "BPC possible (ballasts n\xE9on pr\xE9-1990) — signaler \xE0 l'acheteur" }] },
    ...
    try {
      ...
      if (e?.name === "QuotaExceededError" || e?.code === 22) {
        window.dispatchEvent(new CustomEvent("kzo:storage-quota", {
          detail: { message: "Espace de stockage plein — exportez vos donn\xE9es (Profil â†’ Sauvegarde) puis r\xE9duisez les photos." }
        }));
      }
      throw e;
    }
  ...
  var AI_MODEL_OPTIONS = [
    ...
    { value: "claude-sonnet-4-6", label: "Claude Sonnet 4.6", hint: "Recommand\xE9 — inspection, vision, rapports", provider: "anthropic" },
...
${answerLocally(q, ctx)}`;
  ...
  function stripNumbering(text) {
    return String(text || "").replace(/^(?:Art\.\s*)?\d+(?:\.\d+)*[a-z]?\.?\s*[-—â€“:]*\s*/i, "");
  }
  ...
  var SECTION_MATERIAL_OPTIONS = (() => {
    const m = {
      "walk-toiture": { label: "Type de rev\xEAtement de toiture", options: ["Bardeau d'asphalte (3 tabs)", "Bardeau d'asphalte (architectural / dimensionnel)", "M\xE9tal — acier ou aluminium", "Ardoise naturelle", "Tuile b\xE9ton ou terre cuite", "Cuivre", "Bardeau de c\xE8dre / bois", "EPDM (toit plat — caoutchouc)", "TPO / PVC (toit plat — membrane)", "Gravier-bitume / asphalte (toit plat)", "Polyur\xE9thane gicl\xE9 (toit plat)", "Mixte ou inconnu"] },
      ...
      "aibq-v-iv": { label: "Mat\xE9riaux tuyaux d'amen\xE9e", options: ["Cuivre", "PEX (rouge/bleu/blanc)", "PVC / CPVC", "Acier galvanis\xE9", "Plomb — \xE0 signaler imp\xE9rativement", "Polybutyl\xE8ne — Poly-B (gris) — \xE0 signaler", "Mixte", "Inconnu"] },
      "aibq-v-v": { label: "Amp\xE9rage panneau principal", options: ["60 A — mise \xE0 niveau recommand\xE9e", "100 A", "125 A", "150 A", "200 A", "Panneau \xE0 fusibles (100 A)", "Panneau \xE0 fusibles (60 A ou moins)", "Federal Pacific / Zinsco"] },
      "aibq-v-vi": { label: "Source de chauffage principale", options: ["\xC9lectrique — plinthes", "\xC9lectrique — convecteurs", "Gaz naturel — fournaise \xE0 air forc\xE9", "Gaz naturel — chaudi\xE8re \xE0 eau chaude", "Mazout — fournaise \xE0 air forc\xE9", "Mazout — chaudi\xE8re \xE0 eau chaude", "Propane", "Thermopompe centrale", "Bois / po\xEAle \xE0 bois", "Granules (pellets)", "Bi\xE9nergie", "G\xE9othermie", "Mixte"] },
      ...
      "aibq-v-ix": { label: "Type d'isolation visible (combles)", options: ["Laine de verre souffl\xE9e", "Cellulose souffl\xE9e", "Polyur\xE9thane gicl\xE9 (SPF)", "Laine min\xE9rale (roche)", "Polystyr\xE8ne expans\xE9 (EPS — blanc)", "Polyisocyanurate (jaune / rose)", "Vermiculite (Zonolite) — potentiellement amiant\xE9", "FUUF — mousse ur\xE9e-formald\xE9hyde", "Fibre de verre en nattes", "Mixte ou inconnu"] },
...
<body>
  ...
  function buildLocationMapHtml(site) {
    const addr = [site.adresse, site.ville, site.codePostal, "Qu\xE9bec, Canada"]
      .filter(Boolean).join(", ");
...
<body>
  ...
  // Auto-sauvegarde locale (2 min après 1er save manuel)
  ...
  function navigate(name, params = {}) {
    flushAutosave();
    stopLocalAutoSave(); // arrêter le timer local quand on quitte le dossier
    route = { name, ...params };
    render();
    ...
    <form class="form-grid" id="form-info">
      ...
      <fieldset>
        ...
        ${(() => {
          ...
          if (!yr) return "";
          const alerts = [];
          if (yr < 1980) alerts.push("âš ï¸ <strong>Amiante probable</strong> — bardeaux amiante-ciment, plafond popcorn, tuiles 30\xD730, isolant vermiculite \xE0 v\xE9rifier");
          if (yr < 1975) alerts.push("âš ï¸ <strong>Plomb</strong> — peinture au plomb et tuyaux de plomb possibles");
          if (yr >= 1975 && yr <= 1982) alerts.push("âš ï¸ <strong>FUUF</strong> — mousse ur\xE9e-formald\xE9hyde possible dans les murs (interdit 1980)");
          if (yr < 1990) alerts.push("âš ï¸ <strong>Mercure</strong> — thermostats \xE0 ampoule de mercure probables, <strong>BPC</strong> possible (ballasts n\xE9on)");
          if (yr >= 1985 && yr <= 2005) alerts.push("âš ï¸ <strong>Polybutyl\xE8ne (Poly-B)</strong> — tuyaux gris possible (produit retir\xE9)");
          alerts.push("ðŸ” <strong>Pyrite</strong> — v\xE9rifier dalle b\xE9ton (zones \xE0 risque QC ind\xE9pendamment de l'ann\xE9e)");
          alerts.push("ðŸ” <strong>Radon</strong> — test recommand\xE9 si sous-sol habitable");
          return `<div class="form-alert form-alert--warn" style="grid-column:1/-1;padding:0.75rem 1rem;background:#fffbeb;border:1px solid #f59e0b;border-radius:8px;font-size:0.85rem;line-height:1.6">
            <strong>ðŸ  B\xE2timent ${yr} — \xC9l\xE9ments \xE0 v\xE9rifier selon l'ann\xE9e</strong><br />${alerts.join("<br />")}
          </div>`;
        })()}
  ...
  function bindChecklist(inspection, panel) {
    ...
    panel.querySelectorAll("[data-preset]").forEach((btn) => {
      btn.addEventListener("click", () => {
        ...
        // Trouver le textarea via l'article parent — plus fiable qu'un querySelector par attributs
        const ta = btn.closest(".check-item")?.querySelector("textarea[data-inspector-comment]");
        if (idx >= 0) {
          // Désélection — retirer de selectedPresets seulement (on ne touche pas au commentaire
          // car l'utilisateur peut avoir édité le texte librement)
          item.selectedPresets.splice(idx, 1);
          btn.classList.remove("is-selected");
        } else {
          // Sélection — ajouter à selectedPresets et injecter dans le commentaire
          item.selectedPresets.push(id);
          btn.classList.add("is-selected");
          if (ta && label) {
            const current = (ta.value || "").trim();
            ta.value = current ? current + " \xB7 " + label : label;
            item.inspectorComment = ta.value;
          }
          if (item.status === "non-conforme" || item.status === "a-corriger") {
            autoAddExpert(inspection, getContextId(inspection, si, sub), label);
          }
        }
        scheduleAutosave(inspection, "checklist", panel);
      });
  ...
  function renderInvoicePanel(inspection) {
    ...
    <section class="page-header">
      ...
      ${invoiceNum !== "—" ? `<span class="badge badge--success">${escapeHtml(invoiceNum)}</span>` : '<span class="badge">Num\xE9ro assign\xE9 \xE0 la compl\xE9tion</span>'}
    </section>
    <div class="form-grid">
      ...
      <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:1rem;">
        ...
        <p style="font-size:0.78rem;color:#6b7280;margin:0.5rem 0 0;">${connected ? "Connect\xE9 \xE0 Google" : "Non connect\xE9 — allez dans Profil &rarr; Int\xE9gration Google"}</p>
      </div>
    </div>`;
  }
